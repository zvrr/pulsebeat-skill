...
def main():
    ...
    a=sub.add_parser('html');a.add_argument('--analysis',required=True);a.add_argument('--interpretation',required=True);a.add_argument('--insights');a.add_argument('--media');a.add_argument('--out',required=True);a.set_defaults(fn=html_command)
